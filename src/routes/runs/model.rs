...
pub enum Relation {
    #[sea_orm(
        belongs_to = "crate::routes::passes::model::Entity",
        from = "Column::PassId",
        to = "crate::routes::passes::model::Column::Id"
    )]
    Pass,
    #[sea_orm(has_many = "crate::routes::cover::model::Entity")]
    CoverRow,
}
...
impl Related<crate::routes::cover::model::Entity> for Entity {
    fn to() -> RelationDef {
