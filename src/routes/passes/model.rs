...
pub enum Relation {
    #[sea_orm(
        belongs_to = "crate::routes::transects::model::Entity",
        from = "Column::TransectId",
        to = "crate::routes::transects::model::Column::Id"
    )]
    Transect,
    #[sea_orm(
        belongs_to = "crate::routes::campaigns::model::Entity",
        from = "Column::CampaignId",
        to = "crate::routes::campaigns::model::Column::Id"
    )]
    Campaign,
    #[sea_orm(
        belongs_to = "crate::routes::pass_groups::model::Entity",
        from = "Column::SurveyGroupId",
        to = "crate::routes::pass_groups::model::Column::Id"
    )]
    PassGroup,
    #[sea_orm(has_many = "super::pass_video::Entity")]
    PassVideo,
    #[sea_orm(has_many = "crate::routes::runs::model::Entity")]
    RunRecord,
}

impl Related<crate::routes::transects::model::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Transect.def()
    }
}

impl Related<crate::routes::campaigns::model::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Campaign.def()
    }
}

impl Related<crate::routes::pass_groups::model::Entity> for Entity {
    fn to() -> RelationDef {
