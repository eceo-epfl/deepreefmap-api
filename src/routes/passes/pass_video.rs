...
pub enum Relation {
    ...
    Pass,
    #[sea_orm(
        belongs_to = "crate::routes::videos::model::Entity",
        from = "Column::VideoId",
        to = "crate::routes::videos::model::Column::Id"
    )]
    Video,
}
...
impl Related<crate::routes::videos::model::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Video.def()
    }
}
...
crate::soft_delete_hooks!(PassVideo);
